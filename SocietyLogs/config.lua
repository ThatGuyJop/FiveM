...
Autodealer.Color = "#cc66ff"

-- Autodealer.SocietyNaam = "",
-- Autodealer.SocietyRekening = "",-- Society rekening hier (society-autodealer)
Autodealer.GuildID = "DISCORD_WEBHOOK"-- Guild ID hier
Autodealer.VerkoopWH = "DISCORD_WEBHOOK"-- Verkoop Webhook ID hier
Autodealer.InkoopWH = "DISCORD_WEBHOOK"-- Inkoop Webhook ID hier
Autodealer.GeldWH = "DISCORD_WEBHOOK"-- Geld Webhook ID hier
